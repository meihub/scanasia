          ...
          <td height="940" valign="top"> <div align="center"> 
              <form action="<%=MM_editAction%>" method="POST" enctype="multipart/form-data" name="form1" onSubmit="checkFileUpload(this,'',true,'','','','','','','');return document.MM_returnValue">
                <table width="100%" border="0">
                  <tr> 
                    <td width="21%" class="t2"> <div align="right">产品缩图：</div></td>
                    <td width="77%"> <input name="file" type="file" onChange="checkOneFileUpload(this,'',true,'','','','','','','')">
                   <span class="style1"> (产品尺寸为91*75)</span>
                    </td>
                  </tr>
                  <tr> 
                    <td class="t2">&nbsp;</td>
...
//-->
                            ...
                            <TR vAlign=top align=left> 
                              ...
                              <TD width="65%" align="left" bgColor=#efeff7> <INPUT id=Button12  onClick="return check()" type="submit" name=Button1 value="添加产品"> 
                               &nbsp;<input type="reset" name="Submit4" value="重新设定"></TD>
                            </TR>
...
document.form1.smallid.options[0] = new Option('请选择二级菜单','');
