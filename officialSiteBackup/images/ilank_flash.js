 /**
  * @author [艺龙摄影]www.iLank.cn@
  * @version v2.1.3
  * Date:2007-11-17 2008-2-14
  */
if(typeof(ilank)!="object"){var ilank={}}
ilank.$=function(objId){if(!objId){throw new Error("ilank.$(String objId)参数必须")}
...
ilankFlash=function(C,v,x,V,c,X,i,O,I,l,o){var z=this;if(!document.createElement||!document.getElementById){return}
...
ilankFlash.prototype={getFlashHtml:function(){var I=this,i='<object ';for(var l in I.objAttrs){i+=l+'="'+I.objAttrs[l]+'" '}
...
return RegExp.$1},addParam:function(I,i){this.forSetAttribute(I,i)},getParam:function(){return this.forGetAttribute(name)},write:function(i){var I=this;if(typeof i=="string"){ilank.$(i).innerHTML=I.getFlashHtml()}else if(typeof i=="object"){i.innerHTML=I.getFlashHtml()}}}
