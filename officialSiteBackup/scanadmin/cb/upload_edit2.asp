...
<form action="sub_upload_edit2.asp" method="post" enctype="multipart/form-data" name="form0" id="form0" >
<tr>
...
<input name="B2" type="submit" class="go-wenbenkuang" 
onClick="return Check_FileType()" value="上传" IsShowProcessBar="True"></TD>
<td width=110 align="center" bgcolor="#FFFFFF">
<img name="img" width="165" height="120" id="img" style="display:none"/>
<div id="zi">大图预览</div>
