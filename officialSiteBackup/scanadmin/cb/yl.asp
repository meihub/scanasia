...
%>
            <table width="95" border="0" align="center" cellpadding="0" cellspacing="0" style="float:left;margin:0px 2px 2px 2px">
              <tr>
                <td width="93" height="75" align="center" valign="middle" ><table width="93" border="0" align="center" cellpadding="0" cellspacing="0"  >
                    <tr>
                      <td  width="93" height="75" align="center"><table width="93" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr><td align="center" class="thumbnail" ><A href="../../Showproduct.asp?id=<%=rs("ID")%>" ><img src="../../ProImages/<%=rs("ProImg")%>" onload='DrawImage(this,93,70);' border="0"  style="FILTER: alpha(opacity=100)" ></a></td>
                      </tr></table></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
                <td height="15" align="center" valign="middle" background="images/hb.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
...
<map name="Map">
  <area shape="rect" coords="9,44,116,68" href="yl.asp?ClassID=1">
  <area shape="rect" coords="10,69,116,94" href="yl2.asp?ClassID=2">
  <area shape="rect" coords="8,96,118,120" href="yl2.asp?ClassID=3">
  <area shape="rect" coords="4,122,120,149" href="yl3.asp?ClassID=33">
  <area shape="rect" coords="2,149,119,177" href="yl2.asp?ClassID=5">
  <area shape="rect" coords="2,178,121,204" href="yl3.asp?ClassID=31">
  <area shape="rect" coords="1,205,121,233" href="yl3.asp?ClassID=28">
</map>
</body>
</html>
