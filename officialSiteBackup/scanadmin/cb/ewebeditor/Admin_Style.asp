...
' 当前所有样式列表
Sub ShowStyleList()
	Response.Write "<table align=center border=0 cellpadding=0 cellspacing=0 width='77%' height=40><tr>" & _
		"<td>所有样式列表：</td>" & _
		"<td align=right><a href='?action=styleadd'>新增样式</a></td></tr></table>"

	Response.Write "<table align=center border=0 cellpadding=0 cellspacing=0 class=list1>" & _
...
%>
<table width="78%" height="52" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center">说明：系统自带样式不允许对设置进行删除，但允许查看设置！你可以先“拷贝一标准样式”然后对其设置进行修改以达到快速新建样式的目的。</td>
  </tr>
</table>
