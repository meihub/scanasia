...
function showUploadDialog(s_Type, s_Link, s_Thumbnail){
	...
	var arr = showModalDialog("../dialog/i_upload.htm?style=standard650&type="+s_Type+"&link="+s_Link+"&thumbnail="+s_Thumbnail, window, "dialogWidth:0px;dialogHeight:0px;help:no;scroll:no;status:no");
}
</script>
